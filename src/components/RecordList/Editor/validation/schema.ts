 ...
 */
// function normalize(reasons: { [rule: string]: (Change, context: any) => any }): any {
function normalize(reasons): any {
 ...
 */
function wrapChildrenInDefaultBlock(opts: Options, change: Change, node: Node): Change {
